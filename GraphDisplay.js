class GraphDisplay{
	...
	initdataSets(input){
	    ...
	    this.modeSwitch.attr('style', `position:absolute;left:${this.X_OFFSET + 70}px;top:${this.Y_OFFSET + itemH * input.length + 16}px;cursor:pointer;color:rgb(0,0,238);font-size:1.2em;`);
